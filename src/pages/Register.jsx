...
function Register() {
  ...
  return (
    <>
      <Helmet>
    <title>Register | TRACLE</title>
</Helmet>
<Container fluid className="d-flex flex-column align-items-center justify-content-center bg-custom3 min-vh-100">
    ...
    <div className="register rounded shadow-lg p-4 border border-black" style={{ maxWidth: '400px', width: '100%' }}>
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-2" controlId="confirmpassword">
                ...
                <Form.Control type="password" placeholder="Masukkan Konfirmasi Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
            </Form.Group>
